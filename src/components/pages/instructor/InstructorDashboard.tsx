	...
	return (
		<div className="flex-1 overflow-y-auto">
			<div className="p-8 space-y-6 max-w-5xl mx-auto">
				...
				<div className="glass-panel-strong rounded-[2.5rem] p-8 mt-8">
					<h2 className="text-2xl font-black text-slate-900 dark:text-white mb-8">Manage Quests (Courses)</h2>

					<div className="space-y-4">
						{/* Backend Quest */}
						<div className="flex flex-col md:flex-row md:items-center justify-between p-6 border-2 border-slate-100 dark:border-slate-800 rounded-[2rem] bg-slate-50/50 dark:bg-slate-950/50 hover:border-blue-500/30 transition-colors">
							<div className="mb-4 md:mb-0">
								<span className="inline-block px-3 py-1 bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 text-[10px] font-black uppercase tracking-widest rounded-lg mb-2">Published</span>
							...
							<button className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-black transition-colors">
								Edit Quest
							</button>
						</div>
						...
						<div className="flex flex-col md:flex-row md:items-center justify-between p-6 border-2 border-slate-100 dark:border-slate-800 rounded-[2rem] bg-slate-50/50 dark:bg-slate-950/50 hover:border-blue-500/30 transition-colors">
							<div className="mb-4 md:mb-0">
								<span className="inline-block px-3 py-1 bg-yellow-100 dark:bg-yellow-900/50 text-yellow-700 dark:text-yellow-300 text-[10px] font-black uppercase tracking-widest rounded-lg mb-2">Draft</span>
