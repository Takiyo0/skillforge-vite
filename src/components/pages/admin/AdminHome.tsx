	...
	return (
		<div className="space-y-8">
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
				<div className="p-8 rounded-2xl glass-shell relative overflow-hidden group">
			...
			<div className="bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl rounded-2xl border border-blue-200/60 dark:border-blue-500/15 shadow-xl shadow-blue-950/10 p-8">
				<div className="flex items-center space-x-3 mb-8">
					<div className="w-10 h-10 bg-blue-500/20 text-amber-600 dark:text-amber-400 rounded-2xl flex items-center justify-center">
						<Shield size={24} />
					</div>
				...
				<div className="space-y-6">
					...
					{verificationResult && (
						<div className={`p-8 rounded-2xl border-2 ${verificationResult.valid ? 'border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-900/20' : 'border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20'}`}>
							<div className="flex items-start space-x-4">
								<div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 ${verificationResult.valid ? 'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-600 dark:text-emerald-400' : 'bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400'}`}>
					...
					<table className="min-w-[600px] sm:min-w-0 w-full">
						...
						<tbody>
							<tr className="border-b border-blue-200/60 dark:border-blue-500/15 hover:bg-blue-50/60 dark:hover:bg-blue-500/10 transition-colors">
								...
								<td className="px-4 py-4">
									<span className="inline-block px-3 py-1 bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-300 text-xs font-black uppercase tracking-widest rounded-2xl">Active</span>
								</td>
								<td className="px-4 py-4 text-center">
									<button className="px-4 py-2.5 min-h-[44px] min-w-[44px] bg-slate-200 hover:bg-slate-300 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-900 dark:text-white rounded-2xl font-bold text-sm transition-colors">Edit</button>
								</td>
							</tr>
