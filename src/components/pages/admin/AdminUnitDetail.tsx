...
export function AdminUnitDetail() {
    ...
    return (
        <div className="space-y-4 sm:space-y-6 overflow-y-auto px-2 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-4 md:py-6 max-w-[1600px]">
            ...
            <div
                className="rounded-2xl sm:rounded-[2rem] glass-widget-shell p-3 sm:p-4 md:p-6 flex flex-col gap-4 sm:gap-6">
                <div className="flex flex-col gap-3 sm:gap-4 md:flex-row md:items-start md:justify-between md:gap-6">
                    <div className="space-y-2 sm:space-y-3">
                        ...
                        <div className="flex flex-wrap gap-1.5 sm:gap-2 text-[10px] sm:text-xs font-black uppercase tracking-widest">
                            <span
                                className="px-2.5 sm:px-3 py-1 rounded-lg bg-blue-50/70 dark:bg-blue-500/10 text-slate-700 dark:text-slate-300">
                                {unit.type}
                            </span>
                            <span
                                className="px-2.5 sm:px-3 py-1 rounded-lg bg-blue-50/70 dark:bg-blue-500/10 text-slate-700 dark:text-slate-300">
                    ...
                    <div className="flex items-center gap-2 shrink-0 self-start md:self-auto">
                        <button
                            ...
                            className="p-2 bg-blue-100 dark:bg-blue-900/30 hover:bg-blue-200 dark:hover:bg-blue-900/50 text-blue-600 dark:text-blue-400 rounded-lg transition-colors min-h-[44px] min-w-[44px]"
                            title="Edit unit"
                        >
                            <Edit2 size={18}/>
                        </button>
                        <button
                            ...
                            className="p-2 bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/50 text-red-600 dark:text-red-400 rounded-lg transition-colors min-h-[44px] min-w-[44px]"
                            title="Delete unit"
                        >
                            <Trash2 size={18}/>
                        </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-3 md:gap-4">
                    <div className="rounded-xl sm:rounded-2xl border border-blue-200/60 dark:border-blue-500/15 p-3 sm:p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                    <div
                        className="rounded-xl sm:rounded-2xl border border-blue-200 dark:border-blue-900/60 bg-blue-50 dark:bg-blue-900/20 p-3 sm:p-4 md:p-5">
                        ...
                        <div className="mt-2 sm:mt-3 space-y-2">
                            {unit.prerequisites.length > 0 ? unit.prerequisites.map((prereq) => (
                                <div key={prereq.id}
                                     className="flex items-center justify-between rounded-lg sm:rounded-xl bg-white/80 dark:bg-slate-950/50 border border-blue-100 dark:border-blue-900/40 px-2.5 sm:px-3 py-2">
                                    <div>
                    ...
                    <div
                        className="rounded-xl sm:rounded-2xl border border-emerald-200 dark:border-emerald-900/60 bg-emerald-50 dark:bg-emerald-900/20 p-3 sm:p-4 md:p-5">
                        ...
                        <div className="mt-2 sm:mt-3 space-y-2">
                            {unit.requiredFor.length > 0 ? unit.requiredFor.map((target) => (
                                <div key={target.id}
                                     className="flex items-center justify-between rounded-lg sm:rounded-xl bg-white/80 dark:bg-slate-950/50 border border-emerald-100 dark:border-emerald-900/40 px-2.5 sm:px-3 py-2">
                                    <div>
            ...
            {editOpen && (
                <div className="fixed inset-0 bg-black/50 z-40 flex items-center justify-center p-2 sm:p-4">
                    <div
                        className="bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl rounded-2xl sm:rounded-[2.5rem] border border-blue-200/60 dark:border-blue-500/15 shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                        <div
                        ...
                        <div className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6">
                            ...
                            <div
                                ...
                                <button
                                    ...
                                    disabled={submitting}
                                    className="glass-button-secondary w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl disabled:opacity-50"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    disabled={submitting}
                                    className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-xl disabled:opacity-50 flex items-center justify-center space-x-2"
                                >
                                    {submitting ? (
                                        <>
            ...
            {deleteOpen && (
                <div className="fixed inset-0 bg-black/50 z-40 flex items-center justify-center p-2 sm:p-4">
                    <div
                        className="bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl rounded-2xl sm:rounded-[2.5rem] border border-blue-200/60 dark:border-blue-500/15 shadow-xl max-w-md w-full">
                        <div className="p-4 sm:p-6 md:p-8">
                            ...
                            <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 sm:space-x-3">
                                <button
                                    ...
                                    disabled={submitting}
                                    className="glass-button-secondary w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 text-slate-900 dark:text-white rounded-xl font-bold transition-colors disabled:opacity-50"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    disabled={submitting}
                                    className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-red-600 hover:bg-red-500 text-white rounded-xl font-bold transition-colors disabled:opacity-50 flex items-center justify-center space-x-2"
                                >
                                    {submitting ? (
                                        <>
                                            <Loader size={18} className="animate-spin"/>
