...
export function Sidebar({ role, onLogout }: SidebarProps) {
	...
	return (
		<div className="w-72 h-full rounded-[2rem] glass-shell flex flex-col transition-colors relative z-20 overflow-hidden">
			{/* Logo */}
			<div className="p-8 flex items-center space-x-4">
				<div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-600 flex items-center justify-center text-white font-black text-2xl shadow-lg shadow-blue-500/30">S</div>
				<span className="text-2xl font-black tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-blue-300 dark:to-cyan-300">SkillForge</span>
			</div>
